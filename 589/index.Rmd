...
date         : ""
fontsize     : 10pt
geometry     : vmargin=1in, hmargin=0.75in, headsep=.5in
bibliography : refs/bib/ds4ling_refs.bib
...
\includegraphics[width=0.2\textwidth]{ds4ling.png}
\end{wrapfigure}
...
library(RefManageR)
bib <- ReadBib("./refs/bib/ds4ling_refs.bib", check = FALSE)
ui <- "- "
```
...
```{r, temario-589, child="./calendar/calendar_s2021.Rmd"}
```
