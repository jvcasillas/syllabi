...
While a large part of the class will be spent on basics of how to analyze quantitative data, another goal of the class is to examine the statistical analyses which appear in actual published linguistic literature, and to discuss how students' current and future research might be analyzed statistically. 
...
- Canvas: https://rutgers.instructure.com/courses/339123
...
There will be an in-class exam during the 13th week of the semester (April 
24th). 
...
#| label: temario-658
#| echo: false
readRDS(here::here("658", "calendar", "calendar_s2025.rds")) |> 
